    ...
    <div className="flex flex-col lg:flex-row md:px-10 gap-[50px] lg:gap-[100px]">
        ...
        <div className="mb-10">
            ...
            <div className="grid grid-cols-3 gap-2">
                ...
                <div className="border rounded-md text-center py-3 
                font-medium bg-black/[0.1] opacity-50 cursor-not-allowed">
                    UK 11
                </div>
            </div>
        ...
        <div>
            ...
            giving you a fresh look with a familiar feel. 
            Premium materials with new colours and textures give modern 
